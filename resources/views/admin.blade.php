...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><a class="navbar-brand" href="admin"><h1 style="font-family: Franklin Gothic; color: #592CB7; font-size: 40px;">COV<span style="color: #555;">PEDIA</span></h1></a></div>
				...
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						<h4 class="font-20 weight-500 mb-10 text-capitalize">
							Selamat Datang<div class="weight-600 font-30 text-blue">DI COVPEDIA</div>
						</h4>
						<p class="font-18 max-width-600">Website Untuk Mencari Tempat <br>
                                RAPID Test Ataupun SWAB Test </p>
					</div>
				</div>
			</div>
			<div class="row">
